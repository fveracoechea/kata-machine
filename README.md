# kata-machine
Algorithms and data structure exercises that use arrays, lists, trees, graphs, maps, and search and sorting algorithms.

Credits to: [ThePrimeagen](https://github.com/ThePrimeagen)
